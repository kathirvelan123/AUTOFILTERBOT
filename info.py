...
PICS = (environ.get('PICS' ,'https://telegra.ph/file/74a2140bcf8dd881b0934.jpg')).split()
BOT_START_TIME = time()
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kathirvelan:kathirvelan@autofilter.uxuhsit.mongodb.net/?retryWrites=true&w=majority")
